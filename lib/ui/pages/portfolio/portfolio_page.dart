...
import 'widgets/prediction_vote_list.dart';
  ...
  Future<void> _fetchPortfolio() async {
    ...
    setState(() {
      overview = Portfolio(
        ...
        predictionPointsInvested: 13_500,
      );
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
                ...
                children: [
                  ...
                  if (status == RequestStatus.loading)
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          PortfolioField(label: 'Available Points', value: overview.availableNetWorth),
                          const SizedBox(height: 12),
                          PortfolioField(label: 'Invested Points', value: overview.investmentsTotal),
                          const SizedBox(height: 12),
                          PortfolioField(label: 'In Predictions', value: overview.predictionPointsInvested),
                        ],
                      ),
                    ),
                ],
            ...
            // Prediction votes list
            Card(
              elevation: 0.5,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
              child: const Padding(
                padding: EdgeInsets.all(12),
                child: PredictionVoteList(),
              ),
            ),
